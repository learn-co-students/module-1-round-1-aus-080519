...
# 🐸: Great work Andy!! This is my test file and it runs perfectly! 
...
# 1. Customer:
#   Add review
edwin_review_one = edwin.add_review(coopers, "Best BBQ in AUSTIN!! I would love to visit again and again and again!", 5)
...
mcdonalds_average_rating = mcdonalds.average_star_rating  # Returns 3.0
